...
public class AuthController {
    ...
    public ResponseEntity<Map<String,String>> login(@Valid @RequestBody UserLoginRequest user) {
        ...
        ResponseCookie accessTokenCookie = cookieService.generateAccessTokenCookie(tokenPair.accessToken());
    ...
    public ResponseEntity<Map<String, String>> logout(
        ...
        for(ResponseCookie cookie : deadCookies){
            response = response.header(HttpHeaders.SET_COOKIE, cookie.toString());
        }
        return response.body(Map.of("message", "Logged out successfully"));
    }
    ...
    public ResponseEntity<Map<String, String>> renewTokens(
        ...
        ResponseCookie accessCookie = cookieService.generateAccessTokenCookie(tokenPair.accessToken());
